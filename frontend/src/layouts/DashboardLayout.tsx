...
export default function DashboardLayout() {
    return (
        <div className="min-h-screen bg-marma-bg text-marma-text font-sans">
            {/* Sidebar fijo */}
            <aside className="fixed inset-y-0 left-0 w-64 bg-marma-card/80 backdrop-blur-md border-r border-marma-border shadow-card z-50">
                <div className="flex flex-col h-full px-4 py-6">
                    {/* Logo */}
                    <div className="mb-8 flex items-center space-x-2">
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-marma-accent to-marma-accent-dark shadow-glow" />
                        <span className="text-xl font-semibold tracking-tight">Ticket<span className="text-marma-accent">Flow</span></span>
                    </div>
                    ...
                    <div className="pt-4 border-t border-marma-border">
                        <div className="flex items-center space-x-3">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-marma-text-muted truncate">admin@example.com</p>
                            </div>
                        </div>
                    </div>
                </div>
